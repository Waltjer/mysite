...
You can download the "Stroke Prediction Dataset" [here](https://www.kaggle.com/datasets/fedesoriano/stroke-prediction-dataset#).

# Summary of categorical variables

Always do the data cleaning steps first.
